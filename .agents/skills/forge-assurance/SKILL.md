...
`forge-memory/assets/portable/templates/assurance-result.md` (the sibling
`../forge-memory/assets/portable/templates/assurance-result.md` in a filesystem
Agent Skills install) for the compact result. Write a durable Assurance artifact
only when the user explicitly requests a durable Assurance artifact.
